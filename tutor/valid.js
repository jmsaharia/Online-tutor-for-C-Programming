...
{
     var x1=document.forms["frmquery"]["query_title"].value;
     if(x1==null)
     {
        alert("Please add a meaningful title to your new discussion!");
        return false;
     }
}
function validateReply()
{
    var x1=document.forms["frmreply"]["reply_body"].value;
    if(x1==null)
    {
        alert("No content in the reply box!");
        return false;
    }
}
